...
<a href="https://www.undernet.org/docs/x-commands-english" target="_blank"><b>All X Commands</b></a><br><br>
...
<A HREF="<?=LIVE_LOCATION?>/forgotten_pass.php" target="right">Forgotten password</A><BR><br>
<a href="whatsnew.html" target="right">What's new</a><br><br>
<? if (ENABLE_COMPLAINTS_MODULE == 1) { ?>
<!--<a href="complaints/complaints.php" target="right"><b>Complaints</b></a><br><br>//-->
<? } ?>
