<?
/* $Id: add_l.php,v 1.2 2003/11/05 02:08:43 nighty Exp $ */
	$min_lvl=800;
...
echo "<b>LOCKED USERNAMES</b> Editor (ADD MODE) - <a href=\"./index.php\">Home</a><br><br>\n";
?>
<form name=addentry method=post action=add_entry_l.php>
<table border=1 cellspacing=0 cellpadding=3>
<tr><td align=right><b>user_name_pattern</b>&nbsp;<br>you can use <b>*</b> or <b>?</b> wilds.&nbsp;</td><td><input type=text name=user_name size=40></td></tr>
...
<input type=submit value=" ADD THIS LOCKED USERNAME ENTRY >> ">
</form>
